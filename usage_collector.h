...
public:
    ...
    void DisplayMenu();
    void GetUserChoices(bool& bCollectCpu, bool& bCollectDisk, bool& bCollectNetwork);
    int SaveUsageToFile(const std::string& strFileName, bool bCpu, bool bDisk, bool bNetwork);
